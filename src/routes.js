...
// import MyRobotLayout from "pages/MyRobot/MyRobotLayout";
...
// import MyTaskLayout from "pages/Task/MyTaskLayout";
...
let dashRoutes = [
  ...
  },
  {
    ...
    rtlName: "구매대행",
    icon: StoreIcon,
    state: "DirectPurchaseModuleCollapse",
    isSidebar: true,
    views: [
      {
  ...
  // {
  // TODO: ReactTAble 변경
  //   // TODO: component 수정 예정
  //   path: "/my-robot",
  //   name: "My Robot",
  //   rtlName: "My Robot",
  //   icon: AccountBoxIcon,
  //   component: MyRobotLayout,
  //   layout: "/admin"
  // },
  // {
  //   collapse: true,
  //   name: "Task Modules",
  //   rtlName: "Task Modules",
  //   icon: AndroidIcon,
  //   state: "taskModuleCollapse",
  //   views: [
  //     {
  //       path: "/my-tasks",
  //       name: "My Task",
