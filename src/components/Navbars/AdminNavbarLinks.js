  ...
  return (
    <div className={wrapper}>
      <CustomInput
        ...
        inputProps={{
          placeholder: rtlActive ? "Search" : "검색",
          inputProps: {
            "aria-label": rtlActive ? "Search" : "검색",
